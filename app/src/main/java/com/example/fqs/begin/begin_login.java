...
import com.example.fqs.MainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(getApplicationContext(),begin_register.class);
                startActivity(i);
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.begin_login:
                ...
                CommonParameter.id=string_phone;
                CommonParameter.password=string_password;
//                Toast.makeText(begin_login.this,string_phone+" "+string_password,Toast.LENGTH_SHORT).show();
    ...
    private void postRequest(String phone,String password)  {
        ...
        final Request request = new Request.Builder()
             ...
             //   .addHeader("receipt",CommonParameter.receipt)(请求头！！)
                .post(formBody)
                .build();
        //新建一个线程，用于得到服务器响应的参数
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        if (response.code() >= 200 && response.code() < 300) {
                            ...
                            try {
                                ...
                                if(errCode==0){
                                    Looper.prepare();
                                    Toast.makeText(begin_login.this,"登录成功！",Toast.LENGTH_SHORT).show();
